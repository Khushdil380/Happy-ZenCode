...
class ConfigurationUI {
    ...
    async showConfigurationPanel() {
        const panel = vscode.window.createWebviewPanel('happy-zencode-config', 'Happy Zencode Configuration', vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    async updateOpacity(area, value) {
        const config = vscode.workspace.getConfiguration('happy-zencode');
     ...
     */
    async updateStyling(property, value) {
        const config = vscode.workspace.getConfiguration('happy-zencode');
