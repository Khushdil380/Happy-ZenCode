...
exports.BUILTIN_THEMES = void 0;
exports.getThemeByIndex = getThemeByIndex;
...
function getThemeByIndex(index) {
    if (index < 1 || index > exports.BUILTIN_THEMES.length) {
        return undefined;
    }
    return exports.BUILTIN_THEMES[index - 1];
}
/**
 * Get theme by name
 */
function getThemeByName(name) {
    return exports.BUILTIN_THEMES.find(theme => theme.name.toLowerCase() === name.toLowerCase());
}
/**
 * Get all theme names for quick picker
 */
function getThemeNames() {
    return exports.BUILTIN_THEMES.map(theme => theme.name);
}
